            ...
            <div className="row my-5">
                ...
                <div className="col-md-5">
                    <div className="about-img">
                        <img src="https://cdn.searchenginejournal.com/wp-content/uploads/2022/01/about-us-page-examples-1-61fd8f9784626-sej-1520x800.jpg" className="w-75 img-fluid" alt="" />
                    </div>
                </div>
            </div>
        </div>
